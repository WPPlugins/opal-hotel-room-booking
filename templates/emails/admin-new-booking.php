<?php
 ...
 <p><?php printf( __( 'You have received a reservation from <a href="%s">%s</a>. The order is as follows:', 'opal-hotel-room-booking' ), $admin ? get_edit_post_link( $order->id ) : $order->get_checkout_order_received_url(), $order->get_customer_name() ); ?></p>
...
*/
do_action( 'opalhotel_email_order_details', $order, $admin, $email );

/**
* @hooked OpalHotel_Emails::customer_details() Shows customer details
*/
do_action( 'opalhotel_email_customer_details', $order, $admin, $email );
