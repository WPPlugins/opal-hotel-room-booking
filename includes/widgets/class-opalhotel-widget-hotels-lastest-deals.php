...
class OpalHotel_Widget_Hotels_Lastest_Deals extends WP_Widget {

	/* widget base ID */
	public $id = 'opalhotel-hotels-lastest-deals';
	...
	function __construct() {
		parent::__construct(
			$this->id,
			__( 'OpalHotel: Hotels Lastest Deals', 'opal-hotel-room-booking' ),
			array( 'description' => __( 'Hotels Lastest Deals widget', 'opal-hotel-room-booking' ) ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		OpalHotel_Shortcodes::hotels_lastest_deals( $instance );
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'posts_per_page' ); ?>"><?php esc_html_e( 'Number:', 'opal-hotel-room-booking' ); ?></label>
